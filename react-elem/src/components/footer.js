...
//  navlink <Link> 的特殊版 activeClassName: string
// switch 精确匹配第一个
          ...
          <span className="index_footer_a">
            <NavLink to="/my" activeClassName="active">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g fill="none" fillRule="evenodd" stroke="#666" strokeWidth="4">
                  <g mask="url(#profile-regular.c151d62_c)">
                    <path
                  ...
                  <g mask="url(#profile-regular.c151d62_d)">
                    <path
