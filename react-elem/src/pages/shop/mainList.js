        ...
        <div>
          <div className="commodity_main_list_c">
            <span className="commodity_main_list_img">
              <img
                alt={this.props.valueDes.name}
                title={this.props.valueDes.name}
                src={`https://fuss10.elemecdn.com/${this._formatImg(
                  this.props.valueDes.image_path
            ...
            <section className="commodity_main_list_des">
              ...
              <p className="food_buy">
                ...
                <span>
                  好评率{100 *
                    (
                      this.props.valueDes.satisfy_count /
                      this.props.valueDes.rating_count
                    ).toFixed(2)}%
                </span>
              </p>
